...
Agreement and the provision the parties intend to modify or amend.<br><br>
    ...
    <iframe
      id="JotFormIFrame-251694838691170"
      title="Varian Limited Use Software License Agreement (PlanDeliverySimulator)"
      onload="window.parent.scrollTo(0,0)"
      allowtransparency="true"
      allow="geolocation; microphone; camera; fullscreen; payment"
      src="https://form.jotform.com/251694838691170"
      frameborder="0"
    ...
    <script>window.jotformEmbedHandler("iframe[id='JotFormIFrame-251694838691170']", "https://form.jotform.com/")</script>
